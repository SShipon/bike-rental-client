        ...
        <div className="grid md:grid-cols-2 gap-10">
            ...
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  />
                  <Button type="submit" className="w-full bg-[#F43650]" disabled={isSubmitting}>
          ...
          <Card className="md:order-1">
            <CardHeader>
              ...
              <CardDescription>
                Get in touch with us through any of these means. We're here to help!
              </CardDescription>
            </CardHeader>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    123 Bike Lane, Cycling City, CC 12345<br />
                    Open daily: 8AM - 8PM
                  </p>
                </div>
              </div>
